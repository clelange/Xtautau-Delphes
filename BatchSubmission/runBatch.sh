...
# make process dir
echo "\
$MG5DIR/bin/mg5_aMC $CARDDIR/proc_card_mg5.dat 2>&1 >> myout.txt 2>> myerr.txt"
$MG5DIR/bin/mg5_aMC $CARDDIR/proc_card_mg5.dat >> myout.txt 2>> myerr.txt
...
echo "cp $CARDDIR/${MASS}_param_card.dat $WORKDIR/${PROCESS}/Cards/param_card.dat"
cp $CARDDIR/${MASS}_param_card.dat $WORKDIR/${PROCESS}/Cards/param_card.dat
